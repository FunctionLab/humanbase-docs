...
These examples are drawn from real rebusearch publications and demonstrate the power of HumanBase's integrated approach to analyzing the functional effects of genetic variants, gene expression patterns, and biological networks.
